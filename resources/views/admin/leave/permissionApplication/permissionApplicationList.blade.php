                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;"> <a href="javacript:void(0)" data-status=2 data-leave_permission_id="{{ $value->leave_permission_id }}" class="btn remarksForPermission btn btn-rounded btn-success btn-outline m-r-5"><i class="ti-check text-success m-r-5"></i>@lang('common.approve')</a>
                                            <a href="javacript:void(0)" data-status=3 data-leave_permission_id="{{ $value->leave_permission_id }}" class="btn-rounded remarksForPermission btn btn-danger btn-outline"><i class="ti-close text-danger m-r-5"></i>
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;"> <a href="javacript:void(0)" data-status=2 data-leave_permission_id="{{ $value->leave_permission_id }}" class="btn managerRemarksForPermission btn btn-rounded btn-success btn-outline m-r-5"><i class="ti-check text-success m-r-5"></i>@lang('common.approve')</a>
                                            <a href="javacript:void(0)" data-status=3 data-leave_permission_id="{{ $value->leave_permission_id }}" class="btn-rounded managerRemarksForPermission btn btn-danger btn-outline"><i class="ti-close text-danger m-r-5"></i>
                                                @lang('common.reject')</a>
