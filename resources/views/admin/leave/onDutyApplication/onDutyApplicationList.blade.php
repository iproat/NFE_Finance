                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;"> <a href="javacript:void(0)" data-status=2 data-on_duty_id="{{ $value->on_duty_id }}" class="btn remarksForOnDuty btn btn-rounded btn-success btn-outline m-r-5"><i class="ti-check text-success m-r-5"></i>@lang('common.approve')</a>
                                            <a href="javacript:void(0)" data-status=3 data-on_duty_id="{{ $value->on_duty_id }}" class="btn-rounded remarksForOnDuty btn btn-danger btn-outline"><i class="ti-close text-danger m-r-5"></i>
                            ...
                            <table class="table table-hover manage-u-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px;"> <a href="javacript:void(0)" data-status=2 data-on_duty_id="{{ $value->on_duty_id }}" class="btn managerRemarksForOnDuty btn btn-rounded btn-success btn-outline m-r-5"><i class="ti-check text-success m-r-5"></i>@lang('common.approve')</a>
                                            <a href="javacript:void(0)" data-status=3 data-on_duty_id="{{ $value->on_duty_id }}" class="btn-rounded managerRemarksForOnDuty btn btn-danger btn-outline"><i class="ti-close text-danger m-r-5"></i>
                                                @lang('common.reject')</a>
