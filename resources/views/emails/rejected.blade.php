                    ...
                    <div class="white-box">
                        <div class="login-logo" style="text-align: center">
                            <a href="{{ Url('/') }}"><img src="{!! asset('admin_assets/img/logo.png') !!}"
                                    style="margin-top: 2px;height:50px;margin-bottom: 25px;" /></a>
                        </div>
                        @if ($errors->any())
                        ...
                        <div class="text-center">
                            ...
                            <br>
                            <button class="btn btn-danger text-uppercase waves-effect waves-light" style="width: 120px"
                                aria-readonly="true">Rejected</button>
                            <br><br>
