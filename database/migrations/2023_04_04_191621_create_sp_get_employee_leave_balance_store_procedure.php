...
class CreateSpGetEmployeeLeaveBalanceStoreProcedure extends Migration
{
    ...
    public function up()
    {
        DB::unprepared('DROP PROCEDURE IF EXISTS SP_calculateEmployeeLeaveBalance; CREATE PROCEDURE SP_calculateEmployeeLeaveBalance( IN employeeId int(10),IN leaveTypeId int(10) )  BEGIN
