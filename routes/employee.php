...
Route::group(['middleware' => ['preventbackbutton', 'auth']], function () {
    ...
    Route::group(['prefix' => 'employee'], function () {
        ...
        Route::get('/export', ['as' => 'employee.export', 'uses' => 'Employee\EmployeeController@export']);
    ...
    Route::group(['prefix' => 'templates'], function () {
        Route::get('/employeeTemplate', ['as' => 'templates.employeeTemplate', 'uses' => 'Employee\EmployeeController@employeeTemplate']);
    });

    Route::get('sync/t_usr', 'Employee\EmployeeController@t_usr')->name('sync.t_usr');
    Route::get('sync/employee_group', 'Employee\DepartmentController@employee_group')->name('sync.employee_group');
