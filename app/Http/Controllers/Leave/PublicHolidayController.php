...
class PublicHolidayController extends Controller
{
    ...
    public function create()
    {
        ...
        $leaveTimingList = $this->commonRepository->leaveTimingList();
        $branchList = $this->commonRepository->branchList();
        return view('admin.leave.publicHoliday.form', ['holidayList' => $holidayList, 'leaveTimingList' => $leaveTimingList, 'branchList' => $branchList]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.leave.publicHoliday.form', ['editModeData' => $editModeData, 'holidayList' => $holidayList, 'leaveTimingList' => $leaveTimingList, 'branchList' => $branchList]);
    }
