...
class AttendanceMusterReportExport implements FromCollection, WithHeadings, WithProperties, WithEvents
{
    ...
    public function properties(): array
    {
        return [
            ...
            'creator' => AppConstant::$PLANT,
            'lastModifiedBy' => AppConstant::$PLANT . '',
            'title' => 'Attendance Report',
            'description' => AppConstant::$PLANT . ' - Attendance Report',
            'subject' => AppConstant::$PLANT . ' - Attendance Report',
            'keywords' => 'attendance,export,spreadsheet',
            'category' => 'attendance',
            'manager' => AppConstant::$PLANT . '',
            'company' => AppConstant::$PLANT . '',
        ];
    }
}
